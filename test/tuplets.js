...
run('Singlets', [
    ...
    { beat: 0,   duration: 1,   divisor: 2, rhythm: 2 },
    { beat: 0,   duration: 1,   divisor: 2, rhythm: 2 },
    //{ beat: 0,   duration: 2,   divisor: 3, rhythm: 2 },   // Sort of borderline what should happen here
    { beat: 0,   duration: 2,   divisor: 3, rhythm: 2 },
    { beat: 0,   duration: 2,   divisor: 3, rhythm: 2 },
    { beat: 0,   duration: 2,   divisor: 3, rhythm: 2 },
    { beat: 0,   duration: 2,   divisor: 3, rhythm: 2 },
    { beat: 0,   duration: 2,   divisor: 3, rhythm: 2 },
    { beat: 0,   duration: 2,   divisor: 3, rhythm: 2 },
    //{ beat: 0.5, duration: 0.5, divisor: 2, rhythm: 2 },   // Sort of borderline what should happen here
    { beat: 0.5, duration: 0.5, divisor: 2, rhythm: 2 },
    { beat: 0.5, duration: 0.5, divisor: 2, rhythm: 2 },
    ...
    { beat: 0.5, duration: 0.5, divisor: 2, rhythm: 2 },
    //{ beat: 0.5, duration: 0.5, divisor: 2, rhythm: 2 },
    //{ beat: 0.5, duration: 0.5, divisor: 3, rhythm: 4 },
    //{ beat: 0.75, duration: 0.25, divisor: 2, rhythm: 2 },
    { beat: 0,   duration: 2,   divisor: 2, rhythm: 2 }
], ({ equals, matches }, done) => {
    ...
    matches(detectRhythm(0, 4, [[0.78, 'note', 60, 0.1, 1]]));
    matches(detectRhythm(0, 4, [[0.80, 'note', 60, 0.1, 1]]));
    //matches(detectRhythm(0, 4, [[0.82, 'note', 60, 0.1, 1]]));
    //matches(detectRhythm(0, 4, [[0.84, 'note', 60, 0.1, 1]]));
    //matches(detectRhythm(0, 4, [[0.86, 'note', 60, 0.1, 1]]));
    matches(detectRhythm(0, 4, [[0.88, 'note', 60, 0.1, 1]]));
...
run('Duplets', [
    ...
    { beat: 0, duration: 1,   divisor: 2, rhythm: 1 }, // Quarter note followed by triplets
...
run('Triplets', [
    ...
    // First two of three
    matches(detectRhythm(0, 4, [[0,    'note', 60, 0.1, 0.33], [0.33, 'note', 60, 0.1, 0.33]]));
    // All three
    matches(detectRhythm(0, 4, [[0,    'note', 60, 0.1, 0.33], [0.33, 'note', 60, 0.1, 0.33], [0.67, 'note', 60, 0.1, 0.33]]));
    // Second and third only
    matches(detectRhythm(0, 4, [[0.33, 'note', 60, 0.1, 0.33], [0.67, 'note', 60, 0.1, 0.33]]));
    // Second note only
    matches(detectRhythm(0, 4, [[0.33, 'note', 60, 0.1, 0.33]]));
    // Third note only
    matches(detectRhythm(0, 4, [[0.67, 'note', 60, 0.1, 0.33]]));
    // Third note followed by quarter note
    matches(detectRhythm(0, 4, [[0.67, 'note', 60, 0.1, 0.33], [1,    'note', 60, 0.1, 0.33]]));
...
run('Sextuplets', [
    ...
    { beat: 0,   duration: 2, divisor: 6,  rhythm: 63 },
    { beat: 0,   duration: 2, divisor: 6,  rhythm: 63 },
    { beat: 1,   duration: 1, divisor: 3,  rhythm: 63 },
...
run('Nonuplets', [
    { beat: 0, duration: 1, divisor: 9, rhythm: 511 },
    { beat: 0, duration: 1, divisor: 9, rhythm: 510 },
    { beat: 0, duration: 1, divisor: 9, rhythm: 509 },
], ({ equals, matches }, done) => {
    // All 9
    matches(detectRhythm(0, 4, [
        [0,   'note', 60, 0.1, 1/7],
